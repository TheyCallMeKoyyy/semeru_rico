...
async function pickDeparture(webApp, departure) {
    ...
    await expect(webApp.locator(`xpath=(//span[normalize-space()='AEON MALL DELTAMAS'])[1]`)).toBeVisible();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='CITYWALK LIPPO CIKARANG'])[1]`).click();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='CITYWALK LIPPO CIKARANG'])[1]`).click();
}
...
async function pickArrival(webApp, arrival) {
    ...
    await expect(webApp.locator(`xpath=(//span[normalize-space()='AEON MALL DELTAMAS'])[1]`)).toBeVisible();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='HALTE CITY TOUR MONAS'])[2]`).click();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='HALTE CITY TOUR MONAS'])[2]`).click();
}
...
async function selectDate(webApp, date) {
    ...
    //activating PP
    await webApp.locator("(//input[@id='is_pp'])[1]").click()


    const dateField = webApp.locator("(//input[@id='tanggal_pulang'])[1]");
    await expect(dateField).toBeVisible();
    await dateField.click();
...
async function selectSchedule(webApp) {
    ...
    const scheduleButton = webApp.locator(`xpath=(//button[normalize-space()='Cari Tiket'])[1]`);
...
async function inputPassengerData(webApp, name, email, phoneNumber, custName, seatNumber) {
    ...
    await webApp.locator(`(//button[@id='submit-button'])[1]`).click();
}
...
async function selectSeat(webApp, seatNumber) {
    ...
    const seatLocator = webApp.locator(`xpath=(//p[normalize-space()='11'])[1]`);
...
async function checkingTnc(webApp) {
    ...
    await webApp.locator(`xpath=(//button[normalize-space()='Reservasi Tiket'])[1]`).click();
    await webApp.locator(`xpath=(//button[normalize-space()='Ya, Lanjutkan'])[1]`).click();
}
...
test('reservation', async ({ webApp }) => {
    ...
    await webApp.locator("xpath=(//button[@class='btn color-primary2 px-sm-4 mb-1'][normalize-space()='Pilih'])[1]").click();
