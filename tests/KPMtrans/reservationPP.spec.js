...
async function pickArrival(webApp, arrival) {
    ...
    await expect(webApp.locator(`xpath=(//span[normalize-space()='PERINTIS'])[1]`)).toBeVisible();
    await webApp.locator(`xpath=(//span[normalize-space()='PERINTIS'])[1]`).click();
    await webApp.locator(`xpath=(//span[normalize-space()='PERINTIS'])[1]`).click();
}
...
async function selectSeat(webApp, seatNumber) {
    ...
    const seatLocator = webApp.locator(`xpath=//div[@id='20']//p`);
