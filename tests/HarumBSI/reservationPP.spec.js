...
async function pickDeparture(webApp, departure) {
    ...
    await webApp.locator(`xpath=//div[normalize-space()='CILEUNYI']`).click();
    await webApp.locator(`xpath=//div[normalize-space()='CILEUNYI']`).click();
}
...
async function pickArrival(webApp, arrival) {
    ...
    await expect(webApp.locator(`xpath=(//span[normalize-space()='KOTA BARU ITERA'])[1]`)).toBeVisible();
    await webApp.locator(`xpath=//div[normalize-space()='BANDAR JAYA']`).click();
    await webApp.locator(`xpath=//div[normalize-space()='BANDAR JAYA']`).click();
}
...
async function selectSeat(webApp, seatNumber) {
    ...
    const seatLocator = webApp.locator(`xpath=//div[@id='19']//p`);
