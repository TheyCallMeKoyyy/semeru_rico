...
async function checkBookingCode(webApp, codeBooking) {
    ...
    const codeBookingPath = webApp.locator("xpath=(//a[@class='text-grey'][normalize-space()='Cek Tiket'])[1]")
    ...
    if(codeBooking != ''){
        ...
        fill(codeBooking)
        await webApp.locator("xpath=(//button[normalize-space()='Cek Pesanan'])[1]").click()
