...
async function login(webApp) {
    ...
    await webApp.locator("xpath=(//a[normalize-space()='Daftar/Masuk'])[1]").click();
    ...
    await webApp.locator("xpath=(//div[contains(text(),'Login dengan Nomor Telepon')])[1]").click();
    ...
    // Input phone number
    await webApp.locator("xpath=(//input[@id='no_telepon'])[1]").click();
    ...
    // Submit OTP
    await webApp.locator("xpath=(//button[normalize-space()='Lanjutkan'])[1]").click();
}
