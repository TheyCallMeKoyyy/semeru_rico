...
async function pickDeparture(webApp, departure) {
    ...
    await expect(webApp.locator(`xpath=(//span[normalize-space()='BUAH BATU'])[1]`)).toBeVisible();
    await webApp.locator(`xpath=(//div[normalize-space()='PASTEUR (KUNAFE PUSAT OLEH-OLEH )'])[1]`).click();
    await webApp.locator(`xpath=(//div[normalize-space()='PASTEUR (KUNAFE PUSAT OLEH-OLEH )'])[1]`).click();
}
...
async function pickArrival(webApp, arrival) {
    ...
    await expect(webApp.locator(`xpath=(//span[normalize-space()='BTM CILEGON'])[1]`)).toBeVisible();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='PLAZA SLIPI JAYA'])[2]`).click();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='PLAZA SLIPI JAYA'])[2]`).click();
}
...
async function selectDate(webApp, date) {
    ...
    const dateField = webApp.locator(`(//input[@class='form-control datepicker fs-12 flatpickr-input input active'])[1]`);
...
async function selectSeat(webApp, seatNumber) {
    ...
    const seatLocator = webApp.locator(`xpath=(//span[@class='badge bg-warning promo-badge px-2 py-1 ml-0'][normalize-space()='95,000'])[6]`);
