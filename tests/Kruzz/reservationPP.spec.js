...
async function pickDeparture(webApp, departure) {
    ...
    await webApp.locator(`xpath=(//div[normalize-space()='KRUZZ SOREANG'])[1]`).click();
    await webApp.locator(`xpath=(//div[normalize-space()='KRUZZ SOREANG'])[1]`).click();
}
...
async function pickArrival(webApp, arrival) {
    ...
    await expect(webApp.locator(`xpath=(//span[normalize-space()='KRUZZ BANDUNG CIKAPAYANG'])[1]`)).toBeVisible();
    await webApp.locator(`xpath=(//div[contains(@class,'ss-option')][normalize-space()='KRUZZ SUMEDANG'])[2]`).click();
    await webApp.locator(`xpath=(//div[contains(@class,'ss-option')][normalize-space()='KRUZZ SUMEDANG'])[2]`).click();
}
