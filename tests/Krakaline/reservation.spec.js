...
async function pickDeparture(webApp, departure) {
    ...
    await webApp.locator(`xpath=(//div[normalize-space()='BUAH BATU'])[1]`).click();
    await webApp.locator(`xpath=(//div[normalize-space()='BUAH BATU'])[1]`).click();
}
...
async function pickArrival(webApp, arrival) {
    ...
    await expect(webApp.locator(`xpath=(//span[normalize-space()='AREA FATMAWATI'])[1]`)).toBeVisible();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='AREA VETERAN'])[2]`).click();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='AREA VETERAN'])[2]`).click();
}
 ...
 * @param {import('@playwright/test').Page} webApp - Instance halaman web Playwright.
 * @param {string} date - Tanggal keberangkatan (format: 'DD MMMM YYYY'rw h).
 */
...
async function selectSchedule(webApp) {
    ...
    const scheduleButton = webApp.locator(`xpath=(//button[@class='btn text-white first-bg-color h-100 fs-14 shadow br-button text-uppercase'][normalize-space()='Pilih'])[1]`);
