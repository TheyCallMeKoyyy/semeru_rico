...
async function pickDeparture(webApp, departure) {
    ...
    await webApp.locator(`xpath=(//div[normalize-space()='SIDAREJA'])[1]`).click();
    await webApp.locator(`xpath=(//div[normalize-space()='SIDAREJA'])[1]`).click();
}
...
async function pickArrival(webApp, arrival) {
    ...
    await expect(webApp.locator(`xpath=(//span[normalize-space()='SEMARANG'])[1]`)).toBeVisible();
    //await webApp.locator(`xpath=`).click();
    //await webApp.locator(`xpath=`).click();
}
