...
async function pickDeparture(webApp, departure) {
    ...
    await webApp.locator(`xpath=//div[normalize-space()='BALIKPAPAN BANDARA']`).click();
    await webApp.locator(`xpath=//div[normalize-space()='BALIKPAPAN BANDARA']`).click();
}
...
async function pickArrival(webApp, arrival) {
    ...
    await expect(webApp.locator(`xpath=(//span[normalize-space()='BALIKPAPAN KOTA'])[1]`)).toBeVisible();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='SANGATTA'])[2]`).click();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='SANGATTA'])[2]]`).click();
}
