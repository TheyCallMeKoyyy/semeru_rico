...
async function pickDeparture(webApp, departure) {
    ...
    await webApp.locator(`xpath=(//div[normalize-space()='[VIRTUAL POINT] INDOMARET NGAMPIN AMBARAWA'])[1]`).click();
    await webApp.locator(`xpath=(//div[normalize-space()='[VIRTUAL POINT] INDOMARET NGAMPIN AMBARAWA'])[1]`).click();
}
...
async function pickArrival(webApp, arrival) {
    ...
    await expect(webApp.locator(`xpath=(//span[normalize-space()='AGEN HOTEL CATUR MAGELANG'])[1]`)).toBeVisible();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='MUNTILAN PMI [VIRTUAL POINT]'])[2]`).click();
    await webApp.locator(`xpath=(//div[@class='ss-option'][normalize-space()='MUNTILAN PMI [VIRTUAL POINT]'])[2]`).click();
}
...
async function selectSchedule(webApp) {
    ...
    const scheduleButton = webApp.locator(`xpath=(//button[normalize-space()='Cari'])[1]`);
...
async function selectSeat(webApp, seatNumber) {
    ...
    const seatLocator = webApp.locator(`xpath=//div[@id='10']//p`);
...
test('reservation', async ({ webApp }) => {
    ...
    await webApp.locator("xpath=(//button[@class='btn text-white first-bg-color h-100 fs-14 shadow br-button text-uppercase'][normalize-space()='Pilih'])[1]").click();
