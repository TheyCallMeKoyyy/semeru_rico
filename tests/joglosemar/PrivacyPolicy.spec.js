...
/**
 * @description Mengakses halaman Syarat & Ketentuan Titip Kirim Paket melalui tautan di website.
...
async function accessPrivacyPolicy(webApp) {
    ...
    await webApp.locator("xpath=(//a[normalize-space()='Syarat & Ketentuan Titip Kirim Paket'])[1]").click();
}

/**
 * @description Pengujian untuk mengakses halaman Kebijakan Privasi & Syarat Ketentuan.Titip Kirim Paket
 */
